...
function Clouder(params) {
    ...
    var xScale = 0.6, yScale = 0.8; //LAURA xScale era 0.9. Pongo 0.6 para que qeude más esférica
    var interval = 50;
    var stepAngle = 0.08722;
    var idleMotion = 0.1; //LAURA Velocidad original 0.2, la he puesto a 0.1 para que vaya más despacio.
    var nonSense = 0.025;
    var opaque = 0.2;
    //var opaqueMes = 0.1;
    ...
    function init() {
        ...
        w = container.clientWidth; // LAURA: Cambio clientWidth por clientHeight para que sea esférica
    ...
    function onMouseMove(e) {
        ...
        /////// LAURA: Selecciono el mes sobre el que hago mouseOver y lo marco más
    ...
    function setupSpans() {
        ...
        //Si no hace algo raro: coge el clouder2 y lo mueve como si fuera una etiqueta más.
    ...
    function draw() {
        ...
        process(function(o) {
            ...
            //LAURA Compruebo si la clase es de tipo "mes" y el tamaño lo hago más grande y la opacidad menor
    ...
    function onClick(event) {
        /////// LAURA: Selecciono el mes sobre el que hago click y todos los refranes del mes los pongo más oscuros
        var miMes="";
        if (event.target.className=="mes"){
        ...
        //Recorremos todos los elementos span que hay en la página; por cada uno de ellos:
